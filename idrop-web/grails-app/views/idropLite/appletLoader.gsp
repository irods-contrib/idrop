...
<applet archive="http://localhost:8080/idrop-web/applet/idrop-lite-0.9.9-SNAPSHOT-jar-with-dependencies.jar" code="org.irods.jargon.idrop.lite.iDropLiteApplet" width="100%" height="100%">
