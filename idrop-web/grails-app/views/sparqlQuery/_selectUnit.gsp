	<div class="row-fluid" style="margin-top:30px;" id="region_${divId}">
		...
		<div class="span1 offset0">
			<select id="connector2" style="width:100px;">
		...
		<div class="span2 offset0">
			...
			<label class="checkbox">
				<input type="checkbox" name="searchOption" value="exact"> Exact term
			</label>
			<label class="checkbox">
				<input type="checkbox" name="searchOption" value="narrower"> Narrower terms
			</label>
			<label class="checkbox">
				<input type="checkbox" name="searchOption" value="broader"> Broader terms
			</label>
			<label class="checkbox">
				<input type="checkbox" name="searchOption" value="related"> Related terms
			</label>
			</form>
		</div>
