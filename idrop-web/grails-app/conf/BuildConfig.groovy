...
grails.project.dependency.resolution = {
	...
	dependencies {
		...
		compile ('org.irods.jargon:jargon-core:3.2.1.2-SNAPSHOT')  {
			
				excludes "org.bouncycastle"
			
		}
		//compile 'org.irods.jargon:jargon-security:3.2.0-SNAPSHOT'
		compile ('org.irods.jargon:jargon-data-utils:3.2.1.2-SNAPSHOT')  
		compile ('org.irods.jargon:jargon-ticket:3.2.1.2-SNAPSHOT')  
		compile ('org.irods.jargon:jargon-user-profile:3.2.1.2-SNAPSHOT') 
		compile ('org.irods.jargon:jargon-user-tagging:3.2.1.2-SNAPSHOT') 
