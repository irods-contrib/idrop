...
public class MoveOrCopyiRODSDialog extends javax.swing.JDialog {
    ...
    public MoveOrCopyiRODSDialog(final iDropLiteApplet parent, final boolean modal, final IRODSNode targetNode, final IRODSTree stagingViewTree, final IRODSFile sourceFile, final String targetAbsolutePath, final boolean isCopy) {
    ...
    public MoveOrCopyiRODSDialog(final iDropLiteApplet parent, final boolean modal, final IRODSNode targetNode, final IRODSTree stagingViewTree, final List<IRODSFile> sourceFiles, final String targetAbsolutePath, final boolean isCopy) {
        //super(parent, modal); FIX THIS???
        super((Frame)null, modal);
        this.idrop = parent;
        this.targetNode = targetNode;
