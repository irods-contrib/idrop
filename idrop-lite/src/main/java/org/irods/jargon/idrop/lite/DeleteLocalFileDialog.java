...
public class DeleteLocalFileDialog extends javax.swing.JDialog {
    ...
    public DeleteLocalFileDialog(final iDropLiteApplet parent, final boolean modal, final String directoryToDelete,
    ...
    /** Creates new form to delete a local file */
    public DeleteLocalFileDialog(final iDropLiteApplet parent, final boolean modal,
