...
public class RenameLocalDirectoryDialog extends javax.swing.JDialog {
    ...
    public RenameLocalDirectoryDialog(final iDropLiteApplet parent, final boolean modal, final String currentAbsolutePath, final LocalFileTree localFileTree, final LocalFileNode currentNode) {
