...
public class CopyMoveDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		lblCurrentParent.setText(org.openide.util.NbBundle.getMessage(
				CopyMoveDialog.class, "CopyMoveDialog.lblCurrentParent.text")); // NOI18N
		...
		btnBrowse.setLabel(org.openide.util.NbBundle.getMessage(
				CopyMoveDialog.class, "CopyMoveDialog.btnBrowse.label")); // NOI18N
