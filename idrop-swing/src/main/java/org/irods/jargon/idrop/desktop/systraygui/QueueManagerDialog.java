 ...
 * @author mikeconway
 */
public class QueueManagerDialog extends javax.swing.JDialog implements
	...
	public static org.slf4j.Logger log = LoggerFactory
			.getLogger(QueueManagerDialog.class);
	private DateFormat dateFormat = DateFormat.getDateTimeInstance();

	private int showResubmitConfirm(final LocalIRODSTransfer selectedTransfer) {
		...
		int n = JOptionPane.showConfirmDialog(this, sb.toString(),
				"Resubmit Confirmaiton", JOptionPane.YES_NO_OPTION);

		return n;
	}

	private int showCancelConfirm(final LocalIRODSTransfer selectedTransfer) {
		StringBuilder sb = new StringBuilder();
		...
		// default icon, custom title
		int n = JOptionPane.showConfirmDialog(this, sb.toString(),
				"Cancel Confirmaiton", JOptionPane.YES_NO_OPTION);
	...
	public synchronized void setViewType(final ViewType viewType) {
	...
	public QueueManagerDialog(final iDrop iDropParent,
			final TransferManager transferManager, final ViewType viewType)
		...
		jTableMaster.setModel(new QueueManagerMasterTableModel(
				new ArrayList<LocalIRODSTransfer>()));
	...
	private void initComponents() {
		...
		scrollTransferDetails = new javax.swing.JScrollPane();
		...
		pnlProgress.setBackground(javax.swing.UIManager.getDefaults().getColor(
				"TabbedPane.shadow"));
		...
		org.jdesktop.layout.GroupLayout pnlProgressLayout = new org.jdesktop.layout.GroupLayout(
				pnlProgress);
		...
		pnlProgressLayout.setHorizontalGroup(pnlProgressLayout
				...
				.add(pnlProgressLayout
						.createSequentialGroup()
						.addContainerGap()
						.add(progressBarQueueDetails,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								901,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
		pnlProgressLayout
				.setVerticalGroup(pnlProgressLayout
						.createParallelGroup(
						...
						.add(pnlProgressLayout
								...
								.add(pnlProgressLayout
										...
										.add(lblTransferred)
										.add(lblTransferredOutOf)
										.add(lblCountOutOf).add(lblCountSoFar))
								.add(18, 18, 18)
								.add(progressBarQueueDetails,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		...
		pnlToolbar.setMinimumSize(null);
		pnlToolbar.setPreferredSize(null);
		pnlToolbar.setLayout(new java.awt.GridBagLayout());

		lblHeader.setText("Most Recent iDrop Transfers");
		lblHeader.setMinimumSize(null);
		lblHeader.setPreferredSize(null);
		...
		toolbarQueueManagement.setFloatable(false);
		...
		btnPurgeAll.setMaximumSize(null);
		btnPurgeAll.setMinimumSize(null);
		btnPurgeAll.setPreferredSize(null);
		...
		btnPurgeSuccessful
				.setToolTipText("Purge all completed, successful transfers");
		btnPurgeSuccessful.setFocusable(false);
		btnPurgeSuccessful
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnPurgeSuccessful.setMaximumSize(null);
		btnPurgeSuccessful.setMinimumSize(null);
		btnPurgeSuccessful.setPreferredSize(null);
		btnPurgeSuccessful
		...
		btnDeleteSelected
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnDeleteSelected.setMaximumSize(null);
		btnDeleteSelected.setMinimumSize(null);
		btnDeleteSelected.setPreferredSize(null);
		btnDeleteSelected
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		btnDeleteSelected
				.addActionListener(new java.awt.event.ActionListener() {
		...
		btnCancelSelected
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnCancelSelected.setMaximumSize(null);
		btnCancelSelected.setMinimumSize(null);
		btnCancelSelected.setPreferredSize(null);
		btnCancelSelected
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		btnCancelSelected
				.addActionListener(new java.awt.event.ActionListener() {
		...
		btnRestartSelected
				.setToolTipText("Restart the selected transfer from the current checkpoint");
		btnRestartSelected.setFocusable(false);
		btnRestartSelected
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnRestartSelected.setMaximumSize(null);
		btnRestartSelected.setMinimumSize(null);
		btnRestartSelected.setPreferredSize(null);
		btnRestartSelected
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		btnRestartSelected
				.addActionListener(new java.awt.event.ActionListener() {
		...
		btnResubmitSelected
				.setToolTipText("Resubmit the selected transfer with no restart");
		btnResubmitSelected.setFocusable(false);
		btnResubmitSelected
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnResubmitSelected.setMaximumSize(null);
		btnResubmitSelected.setMinimumSize(null);
		btnResubmitSelected.setPreferredSize(null);
		btnResubmitSelected
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		btnResubmitSelected
				.addActionListener(new java.awt.event.ActionListener() {
		...
		btnRefreshView
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		btnRefreshView.setMaximumSize(null);
		btnRefreshView.setMinimumSize(null);
		btnRefreshView.setPreferredSize(null);
		btnRefreshView
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		...
		toggleAutoRefresh
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		toggleAutoRefresh.setMaximumSize(null);
		toggleAutoRefresh.setMinimumSize(null);
		toggleAutoRefresh.setPreferredSize(null);
		toggleAutoRefresh
				.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		toggleAutoRefresh
				.addActionListener(new java.awt.event.ActionListener() {
		...
		jScrollPaneMaster.setMinimumSize(null);
		...
		jTableMaster.setPreferredSize(null);
		jTableMaster
		...
		tabDetails.setRequestFocusEnabled(false);

		pnlTransferDetailsSummary
				.setPreferredSize(new java.awt.Dimension(0, 0));
		pnlTransferDetailsSummary.setLayout(new java.awt.BorderLayout());

		pnlTransferProgress.setBorder(javax.swing.BorderFactory
				.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
		pnlTransferProgress.setMinimumSize(null);
		...
		pnlTransferFileCounts.setPreferredSize(null);

		lblTransferFilesCounts.setText("Files: /");
		lblTransferFilesCounts.setMaximumSize(null);
		lblTransferFilesCounts.setMinimumSize(null);
		lblTransferFilesCounts.setPreferredSize(null);
		...
		pnlTransferFileInfo.setPreferredSize(null);
		pnlTransferFileInfo.setLayout(new java.awt.FlowLayout(
				java.awt.FlowLayout.LEFT));

		lblCurrentFileLabel.setText("Current File:");
		lblCurrentFileLabel.setMinimumSize(null);
		lblCurrentFileLabel.setPreferredSize(null);
		...
		pnlTransferProgress.add(pnlTransferOverview,
		...
		transferStatusProgressBar.setPreferredSize(new java.awt.Dimension(400,
				20));
		transferStatusProgressBar.setSize(new java.awt.Dimension(200, 0));
		...
		lblTransferTypeLabel.setPreferredSize(null);
		lblTransferTypeLabel.setRequestFocusEnabled(false);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 1;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		lblTransferStatusLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		...
		pnlTransferInfoBasicStats.add(lblTransferStatusLabel,
				gridBagConstraints);
		gridBagConstraints = new java.awt.GridBagConstraints();
		...
		lblProcessingStateLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 0;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
		pnlTransferInfoBasicStats.add(lblProcessingStateLabel,
				gridBagConstraints);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 0;
		...
		btnSynchronization.setMaximumSize(null);
		btnSynchronization.setMinimumSize(null);
		btnSynchronization.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		...
		lblHostLabel.setOpaque(true);
		lblHostLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		lblZoneLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 3;
		gridBagConstraints.gridy = 3;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
		gridBagConstraints.insets = new java.awt.Insets(10, 0, 0, 0);
		pnlTransferInfoBasicStats
				.add(lblTransferStartLabel, gridBagConstraints);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 2;
		gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
		...
		lblTransferEndLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 3;
		gridBagConstraints.gridy = 2;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		lblSourceLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		lblSource.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		lblSource.setMaximumSize(null);
		lblSource.setMinimumSize(null);
		...
		lblTargetLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		lblTarget.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		lblTarget.setMinimumSize(null);
		lblTarget.setPreferredSize(null);
		lblTarget.setRequestFocusEnabled(false);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 6;
		gridBagConstraints.gridwidth = 7;
		...
		lblLastPathLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		lblLastPath.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		lblLastPath.setMinimumSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 7;
		gridBagConstraints.gridwidth = 7;
		...
		lblErrorMessageLabel.setPreferredSize(null);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		scrollTransferDetails.setViewportView(pnlTransferInfoBasicStats);

		pnlTransferDetailsSummary.add(scrollTransferDetails,
				java.awt.BorderLayout.CENTER);
		...
		radioShowAll.setMaximumSize(null);
		radioShowAll.setMinimumSize(null);
		...
		radioShowError
				.setToolTipText("Show only transfer items that were in error");
		radioShowError.setMaximumSize(null);
		radioShowError.setMinimumSize(null);
		...
		jTableDetails.setMinimumSize(null);
		jTableDetails.setPreferredSize(null);
		jTableDetails
				.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
		jScrollPaneDetails.setViewportView(jTableDetails);

		pnlTransferDetailsTable.add(jScrollPaneDetails,
				java.awt.BorderLayout.CENTER);
		...
		jMenuCurrent
				.setToolTipText("Show the queue of transfers waiting to process");
	...
	private void radioShowAllActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_radioShowAllActionPerformed
		if (radioShowAll.isSelected()) {
			adjustDetails();
		}
	}// GEN-LAST:event_radioShowAllActionPerformed

	private void radioShowErrorActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_radioShowErrorActionPerformed
		if (radioShowError.isSelected()) {
			adjustDetails();
		}
	}// GEN-LAST:event_radioShowErrorActionPerformed

	private void jMenuCurrentActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuCurrentActionPerformed
		refreshTableView(QueueManagerDialog.ViewType.CURRENT);

	}// GEN-LAST:event_jMenuCurrentActionPerformed

	private void jMenuRecentActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuRecentActionPerformed
		refreshTableView(QueueManagerDialog.ViewType.RECENT);

	}// GEN-LAST:event_jMenuRecentActionPerformed

	private void jMenuErrorActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuErrorActionPerformed
		refreshTableView(QueueManagerDialog.ViewType.ERROR);

	}// GEN-LAST:event_jMenuErrorActionPerformed

	private void jMenuWarningActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuWarningActionPerformed
	...
	private void btnPurgeAllActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnPurgeAllActionPerformed
		try {
			...
			Logger.getLogger(QueueManagerDialog.class.getName()).log(
	...
	private void btnPurgeSuccessfulActionPerformed(
		...
		try {
			iDropParent.getiDropCore().getTransferManager()
	...
	private void btnDeleteSelectedActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteSelectedActionPerformed
		...
		QueueManagerMasterTableModel tableModel = (QueueManagerMasterTableModel) jTableMaster
				.getModel();
		LocalIRODSTransfer selectedTransfer = tableModel
	...
	private void btnCancelSelectedActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnCancelSelectedActionPerformed
	...
	private void btnRefreshViewActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRefreshViewActionPerformed
		refreshTableView(getViewType());
	}// GEN-LAST:event_btnRefreshViewActionPerformed

	private void toggleAutoRefreshActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_toggleAutoRefreshActionPerformed
		...
		if (toggleAutoRefresh.isSelected()) {
			...
			try {
				refreshQueueManagerTimerTask = RefreshQueueManagerTimerTask
						.instance(this);
				refreshQueueTimer.scheduleAtFixedRate(
						refreshQueueManagerTimerTask, 0, 10000);
	...
	/**
	 * Refresh the data in the queue table from the database. This method will
	 * automatically maintain the view on whatever the currently selected
	 * transfer is. If that transfer is not in the view, it will select the
	...
	public final void refreshTableView(final ViewType viewType) {
		...
		final QueueManagerMasterTableModel masterTableModel = (QueueManagerMasterTableModel) jTableMaster
				.getModel();
		...
		if (selectedRow > -1) {
			selectedMasterTableObject = masterTableModel
					.getTransferAtRow(jTableMaster
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				queueManagerDialog.setCursor(Cursor
				...
				try {
					...
					MessageManager.showError(queueManagerDialog,
							e.getMessage(), MessageManager.TITLE_MESSAGE);
				} finally {
					queueManagerDialog.setCursor(Cursor
			...
			private void updateDetailsWIthSelectedTable() throws Exception {
				...
				if (viewType == ViewType.CURRENT) {
					...
					queueManagerDialog.getLblHeader().setText(
				...
				if (transferQueue != null) {
					...
					if (selectedMasterTableObject != null) {
						...
						for (int i = 0; i < jTableMaster.getModel()
								.getRowCount(); i++) {
							transfer = masterTableModel.getTransferAtRow(i);
							if (transfer.getId() == selectedMasterTableObject
									.getId()) {
						...
						if (matchingRowForSelected != -1) {
							int selectedRowIndex = jTableMaster
									.convertRowIndexToView(matchingRowForSelected);
							if (selectedRowIndex != -1) {
								jTableMaster.setRowSelectionInterval(
	...
	private javax.swing.JScrollPane scrollTransferDetails;
	...
	public void setLblHeader(final JLabel lblHeader) {
	...
	private void adjustDetails() {
		final LocalIRODSTransfer localIRODSTransfer = ((QueueManagerMasterTableModel) jTableMaster
				.getModel()).getTransferAtRow(jTableMaster
				.convertRowIndexToModel(jTableMaster.getSelectedRow()));
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				lblTransferType.setText(localIRODSTransfer.getTransferType()
						.toString());
				lblTransferStatus.setText(localIRODSTransfer
						.getTransferStatus().toString());
				...
				lblProcessingState.setText(localIRODSTransfer
						.getTransferState().toString());
				...
				if (localIRODSTransfer.getTransferStart() != null) {
					lblTransferStart.setText(dateFormat
							.format(localIRODSTransfer.getTransferStart()));
				}

				if (localIRODSTransfer.getTransferEnd() != null) {
					lblTransferEnd.setText(dateFormat.format(localIRODSTransfer
							.getTransferEnd()));
				}

				lblLastPath.setText(IDropUtils
						.abbreviateFileName(localIRODSTransfer
				...
				// set source and target properly based on activity (put, get,
				// etc)
				...
				lblTransferType1.setText(localIRODSTransfer.getTransferType()
						.toString());

				lblCountSoFar.setText(String.valueOf(localIRODSTransfer
						.getTotalFilesTransferredSoFar()));
				lblCountOutOf.setText(String.valueOf(localIRODSTransfer
						.getTotalFilesCount()));
				lblTransferFilesCounts.setText("Files: "
						+ localIRODSTransfer.getTotalFilesTransferredSoFar()
						+ " / " + localIRODSTransfer.getTotalFilesCount());
				transferStatusProgressBar.setMinimum(0);
				transferStatusProgressBar.setMaximum(localIRODSTransfer
						.getTotalFilesCount());
				transferStatusProgressBar.setValue(localIRODSTransfer
						.getTotalFilesTransferredSoFar());
				// initialize the detail values via hibernate (they are lazily
				// loaded)
				...
				try {
					if (showAll) {
						...
						jTableDetails.setModel(new QueueManagerDetailTableModel(
								transferManager
										.getAllTransferItemsForTransfer(localIRODSTransfer
												.getId())));
					} else {
						jTableDetails.setModel(new QueueManagerDetailTableModel(
								transferManager
										.getErrorTransferItemsForTransfer(localIRODSTransfer
												.getId())));
					}
	...
	public int showRestartConfirm(final LocalIRODSTransfer localIRODSTransfer) {
		...
		// default icon, custom title
		int n = JOptionPane.showConfirmDialog(this, sb.toString(),
				"Restart Confirmation", JOptionPane.YES_NO_OPTION);
