...
// ActionListener {
public class DeprecatedTransferManagerDialog extends javax.swing.JDialog
		implements ListSelectionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -913240957328843561L;
	 ...
	 */
	public DeprecatedTransferManagerDialog(final iDrop parent)
	...
	private void initTransferTable() throws ConveyorExecutionException {
		...
		// try {
		// Transfer transfer =
		// idropCore.getConveyorService().getQueueManagerService().findTransferByTransferId(transferID);
		// Transfer transferWithChildren =
		// idropCore.getConveyorService().getQueueManagerService().initializeGivenTransferByLoadingChildren(transfer);
		...
		// SimpleDateFormat("EEE, MMM, d, yyyy : h:mm:ss a");
		// int count =1;
		//
	...
	private void initComponents() {
		...
		setTitle(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.title")); // NOI18N
		...
		btnTransferInfo.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnTransferInfo.text")); // NOI18N
		btnTransferInfo.setToolTipText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnTransferInfo.toolTipText")); // NOI18N
		...
		btnPurgeAll.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnPurgeAll.text")); // NOI18N
		btnPurgeAll.setToolTipText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnPurgeAll.toolTipText")); // NOI18N
		...
		btnPurgeSuccessful.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnPurgeSuccessful.text")); // NOI18N
		btnPurgeSuccessful
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(DeprecatedTransferManagerDialog.class,
								"DeprecatedTransferManagerDialog.btnPurgeSuccessful.toolTipText")); // NOI18N
		...
		btnRemoveSelected.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnRemoveSelected.text")); // NOI18N
		btnRemoveSelected
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(DeprecatedTransferManagerDialog.class,
								"DeprecatedTransferManagerDialog.btnRemoveSelected.toolTipText")); // NOI18N
		...
		btnCancel.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnCancel.text")); // NOI18N
		btnCancel.setToolTipText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnCancel.toolTipText")); // NOI18N
		...
		btnRestartSelected.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnRestartSelected.text")); // NOI18N
		btnRestartSelected
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(DeprecatedTransferManagerDialog.class,
								"DeprecatedTransferManagerDialog.btnRestartSelected.toolTipText")); // NOI18N
		...
		btnResubmitSelected.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnResubmitSelected.text")); // NOI18N
		btnResubmitSelected
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(DeprecatedTransferManagerDialog.class,
								"DeprecatedTransferManagerDialog.btnResubmitSelected.toolTipText")); // NOI18N
		...
		btnRefresh.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnRefresh.text")); // NOI18N
		btnRefresh.setToolTipText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.btnRefresh.toolTipText")); // NOI18N
		...
		bntClose.setText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.bntClose.text")); // NOI18N
		bntClose.setToolTipText(org.openide.util.NbBundle.getMessage(
				DeprecatedTransferManagerDialog.class,
				"DeprecatedTransferManagerDialog.bntClose.toolTipText")); // NOI18N
	...
	private void btnTransferInfoActionPerformed(
		...
		DeprecatedTransferInfoDialog transferInfoDialog = new DeprecatedTransferInfoDialog(
