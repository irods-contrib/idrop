...
public interface IdropConfigurationService {
	...
	/**
	 * Update the configuration database, and update the cached configs, with
	 ...
	 * @throws IdropException
	 */
	void updateConfig(final String key, final String value)
			throws IdropException;

	/**
	 * Save a given iRODS account as a cached last login in the configuration
	 * database
	 * 
	 * @param irodsAccount
	...
	/**
	 * Set the idrop configuration to values defined in the jargon properties
	 * file in the classpath. These should contain (hopefully) sensible defaults
	 * 
