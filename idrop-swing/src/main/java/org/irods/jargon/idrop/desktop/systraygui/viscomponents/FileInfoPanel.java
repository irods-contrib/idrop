...
public class FileInfoPanel extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		lblFileOrCollectionName.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class,
				"FileInfoPanel.lblFileOrCollectionName.text")); // NOI18N
		lblFileOrCollectionName
		...
		lblFileParentLabel.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblFileParentLabel.text")); // NOI18N
		pnlInfoCollectionParent.add(lblFileParentLabel,
				java.awt.BorderLayout.NORTH);

		lblFileParent.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblFileParent.text")); // NOI18N
		lblFileParent.setMinimumSize(new java.awt.Dimension(80, 30));
		pnlInfoCollectionParent
				.add(lblFileParent, java.awt.BorderLayout.CENTER);
		...
		lblInfoUpdatedAt.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblInfoUpdatedAt.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 1;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		lblInfoUpdatedAtValue.setText(org.openide.util.NbBundle
				.getMessage(FileInfoPanel.class,
						"FileInfoPanel.lblInfoUpdatedAtValue.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		...
		lblInfoLength
				.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
		lblInfoLength.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblInfoLength.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		lblInfoLengthValue.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblInfoLengthValue.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 3;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		lblInfoChecksum
				.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
		lblInfoChecksum.setText(org.openide.util.NbBundle.getMessage(
				FileInfoPanel.class, "FileInfoPanel.lblInfoChecksum.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 2;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		lblInfoChecksumValue
				.setText(org.openide.util.NbBundle.getMessage(
						FileInfoPanel.class,
						"FileInfoPanel.lblInfoChecksumValue.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 2;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
