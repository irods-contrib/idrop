...
public class TransferFileListDialog extends javax.swing.JDialog {
	 ...
	 */
	public TransferFileListDialog(javax.swing.JDialog parent,
			TransferAttempt transferAttempt, IDROPCore idropCore) {
		super(parent, true);
		initComponents();
		...
		try {
			this.tableModel = new ItemListPagingTableModel(itemsPerPage,
