...
public class FileInfoDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		fileInfoArea.setLayout(new javax.swing.BoxLayout(fileInfoArea,
				javax.swing.BoxLayout.LINE_AXIS));
		getContentPane().add(fileInfoArea, java.awt.BorderLayout.CENTER);

		fileInfoButtons.setLayout(new java.awt.FlowLayout(
		...
		btnOK.setText(org.openide.util.NbBundle.getMessage(
				FileInfoDialog.class, "FileInfoDialog.btnOK.text")); // NOI18N
		btnOK.setToolTipText(org.openide.util.NbBundle.getMessage(
				FileInfoDialog.class, "FileInfoDialog.btnOK.toolTipText")); // NOI18N
