...
public class DownloadDialog extends javax.swing.JDialog implements
	...
	private void initComponents() {
		...
		pnlFileSection.setBorder(javax.swing.BorderFactory.createEmptyBorder(6,
				6, 6, 6));
		...
		tblFilesToDownload.setModel(new javax.swing.table.DefaultTableModel(
			 ...
			 * 
			 */
			private static final long serialVersionUID = 4699152972543489522L;
		...
		btnAddDownloadFile.setToolTipText(org.openide.util.NbBundle.getMessage(
				DownloadDialog.class,
				"DownloadDialog.btnAddDownloadFile.toolTipText")); // NOI18N
		btnAddDownloadFile
		...
		btnDeleteDownloadFile.setToolTipText(org.openide.util.NbBundle
				.getMessage(DownloadDialog.class,
						"DownloadDialog.btnDeleteDownloadFile.toolTipText")); // NOI18N
		btnDeleteDownloadFile
				.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(
		...
		pnlFileSection.add(pnlDownloadFileContainer,
				java.awt.BorderLayout.CENTER);
		...
		txtDownloadTarget.setText(org.openide.util.NbBundle.getMessage(
				DownloadDialog.class, "DownloadDialog.text")); // NOI18N
		...
		btnCancel.setToolTipText(org.openide.util.NbBundle.getMessage(
				DownloadDialog.class, "DownloadDialog.btnCancel.toolTipText")); // NOI18N
		...
		btnDownloadNow.setToolTipText(org.openide.util.NbBundle.getMessage(
				DownloadDialog.class,
				"DownloadDialog.btnDownloadNow.toolTipText")); // NOI18N
