...
public class SetupWizard extends javax.swing.JDialog {
    ...
    public SetupWizard(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        panelTabNameDeviceQuestion.add(jScrollPane2, java.awt.BorderLayout.CENTER);
    ...
    private void btnSeeSystemTrayNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeeSystemTrayNoActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SetupWizard dialog = new SetupWizard(new javax.swing.JFrame(), true);
