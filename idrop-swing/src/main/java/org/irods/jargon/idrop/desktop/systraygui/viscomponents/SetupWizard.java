 ...
 * 
 * @author mikeconway d.setLocationRelativeTo(null);
 */
public class SetupWizard extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8012250428476636916L;
	...
	private void initComponents() {
		...
		setTitle(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.title")); // NOI18N
		...
		jLabel2.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.jLabel2.text")); // NOI18N
		...
		jLabel3.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.jLabel3.text")); // NOI18N
		...
		jLabel4.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.jLabel4.text")); // NOI18N
		pnlInitialSynchSetupQuestion.add(jLabel4);

		pnlInitialSynchSetup.add(pnlInitialSynchSetupQuestion,
				java.awt.BorderLayout.CENTER);
		...
		txtLocalPath.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.txtLocalPath.text")); // NOI18N
		txtLocalPath.setToolTipText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.txtLocalPath.toolTipText")); // NOI18N
		...
		btnChooseLocalSynch.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnChooseLocalSynch.text")); // NOI18N
		btnChooseLocalSynch.setToolTipText(org.openide.util.NbBundle
				.getMessage(SetupWizard.class,
						"SetupWizard.btnChooseLocalSynch.toolTipText")); // NOI18N
		btnChooseLocalSynch
				.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(
		...
		txtIrodsPath.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.txtIrodsPath.text")); // NOI18N
		txtIrodsPath.setToolTipText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.txtIrodsPath.toolTipText")); // NOI18N
		...
		btnChooseIrodsSynch.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnChooseIrodsSynch.text")); // NOI18N
		btnChooseIrodsSynch.setToolTipText(org.openide.util.NbBundle
				.getMessage(SetupWizard.class,
						"SetupWizard.btnChooseIrodsSynch.toolTipText")); // NOI18N
		btnChooseIrodsSynch
				.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(
		...
		jLabel1.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.jLabel1.text")); // NOI18N
		...
		radioSynch.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.radioSynch.text")); // NOI18N
		...
		jLabel5.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.jLabel5.text")); // NOI18N
		...
		jcomboSynchFrequency.setToolTipText(org.openide.util.NbBundle
				.getMessage(SetupWizard.class,
						"SetupWizard.jcomboSynchFrequency.toolTipText")); // NOI18N
		...
		pnlInitialSynchSetupAnswer.add(pnlSynchData,
				new java.awt.GridBagConstraints());

		pnlInitialSynchSetup.add(pnlInitialSynchSetupAnswer,
				java.awt.BorderLayout.SOUTH);

		tabWizardTabs.addTab(org.openide.util.NbBundle.getMessage(
				SetupWizard.class,
				"SetupWizard.pnlInitialSynchSetup.TabConstraints.tabTitle"),
				pnlInitialSynchSetup); // NOI18N
		...
		pnlWizardToolbar.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());

		btnBack.setMnemonic('b');
		btnBack.setText(org.openide.util.NbBundle.getMessage(SetupWizard.class,
				"SetupWizard.btnBack.text")); // NOI18N
		btnBack.setToolTipText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnBack.toolTipText")); // NOI18N
		...
		btnForward.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnForward.text")); // NOI18N
		btnForward.setToolTipText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnForward.toolTipText")); // NOI18N
		...
		btnLater.setText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnLater.text")); // NOI18N
		btnLater.setToolTipText(org.openide.util.NbBundle.getMessage(
				SetupWizard.class, "SetupWizard.btnLater.toolTipText")); // NOI18N
	...
	/**
	 * User indicates that he can see the system tray icon, right now should not
	 * show GUI at startup
	 * 
	 * @param evt
	 */
	private void btnSeeSystemTrayYesActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSeeSystemTrayYesActionPerformed
	...
	private void saveSeeSystemTrayYes() throws IdropRuntimeException {
		...
		try {
			idropConfigurationService.updateConfig(
					IdropConfigurationService.SHOW_GUI, "false");
	...
	private void saveDeviceName() {
		if (txtDeviceName.getText().length() == 0) {
			...
			MessageManager.showError(this, "Device name is not entered",
					SETUP_ERROR_TITLE);
			return;
		}
		try {
			idropConfigurationService.updateConfig(
					IdropConfigurationService.DEVICE_NAME,
	...
	private void tabWizardTabsKeyPressed(final java.awt.event.KeyEvent evt) {// GEN-FIRST:event_tabWizardTabsKeyPressed
	...
	private void btnLaterActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnLaterActionPerformed
		...
		try {
			...
			idropConfigurationService
					.removeConfigProperty(IdropConfigurationService.DEVICE_NAME);
			log.info("config is updated");
		} catch (IdropException ex) {
			log.error("error updating configuration", ex);
			throw new IdropRuntimeException("error updating configuration", ex);
	...
	private void btnChooseLocalSynchActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnChooseLocalSynchActionPerformed
	...
	private void btnChooseIrodsSynchActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnChooseIrodsSynchActionPerformed
		try {
	...
	private void txtIrodsPathActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_txtIrodsPathActionPerformed
		// TODO add your handling code here:
	}// GEN-LAST:event_txtIrodsPathActionPerformed

	private void txtLocalPathActionPerformed(
			final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_txtLocalPathActionPerformed
		// TODO add your handling code here:
	...
	private void advanceTab() {
		...
		if (currentTab == 2) {
			try {
				if (idropCore.getTransferManager().getTransferServiceFactory()
						.instanceSynchManagerService()
						.listAllSynchronizations().size() > 0) {
	...
	private void saveSynch() {
		if (txtLocalPath.getText().trim().length() == 0
				&& txtIrodsPath.getText().trim().length() == 0) {
			...
			try {
				...
				synchronization.setDefaultResourceName(idropCore
						.getIrodsAccount().getDefaultStorageResource());

				synchronization.setIrodsHostName(idropCore.getIrodsAccount()
						.getHost());

				synchronization.setIrodsPassword(HibernateUtil
						.obfuscate(idropCore.getIrodsAccount().getPassword()));

				synchronization.setIrodsPort(idropCore.getIrodsAccount()
						.getPort());
				synchronization.setIrodsSynchDirectory(txtIrodsPath.getText());
				synchronization.setLocalSynchDirectory(txtLocalPath.getText());
				synchronization.setIrodsUserName(idropCore.getIrodsAccount()
						.getUserName());
				synchronization.setIrodsZone(idropCore.getIrodsAccount()
						.getZone());
				...
				idropConfigurationService
						.createNewSynchronization(synchronization);
				advanceTab();
