        ...
        pnlCurrentParentLayout.setHorizontalGroup(pnlCurrentParentLayout.createParallelGroup(
                ...
                pnlCurrentParentLayout
                        ...
                        .add(pnlCurrentParentLayout
                                ...
                                .add(txtNewFolder)
                                .add(scrollCurrentParent, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 413,
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    try {
                        irodsFileService = new IRODSFileService(idrop.getIrodsAccount(), idrop.getiDropCore()
                                .getIrodsFileSystem());
                    ...
                    IRODSNode newNode = new IRODSNode(entry, idrop.getIrodsAccount(), idrop.getiDropCore()
