...
public class IDROPConfigurationPanel extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		pnlTopLayout.setHorizontalGroup(pnlTopLayout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(0, 1077,
				Short.MAX_VALUE));
		...
		lblMaxTransferErrors.setText(org.openide.util.NbBundle.getMessage(
				IDROPConfigurationPanel.class,
				"IDROPConfigurationPanel.lblMaxTransferErrors.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		...
		spinnerMaxTransferErrors.setModel(new javax.swing.SpinnerNumberModel(0,
				0, 600, 10));
		spinnerMaxTransferErrors
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(IDROPConfigurationPanel.class,
								"IDROPConfigurationPanel.spinnerMaxTransferErrors.toolTipText")); // NOI18N
		spinnerMaxTransferErrors
		...
		plnPipelineConfigurationDetails
				.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle
						.getMessage(IDROPConfigurationPanel.class,
								"IDROPConfigurationPanel.plnPipelineConfigurationDetails.border.title"))); // NOI18N
		...
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
		plnPipelineConfigurationDetails.add(lblIrodsSocketTimeout,
				gridBagConstraints);
		...
		gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
		gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
		plnPipelineConfigurationDetails.add(spinnerIrodsSocketTimeout,
				gridBagConstraints);
		...
		gridBagConstraints.gridy = 1;
		gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
		plnPipelineConfigurationDetails.add(pnlParallelTransferOptions,
				gridBagConstraints);
		...
		gridBagConstraints.gridx = 2;
		gridBagConstraints.gridy = 3;
		plnPipelineConfigurationDetails.add(btnRestoreDefaults,
				gridBagConstraints);
		...
		gridBagConstraints.gridy = 3;
		plnPipelineConfigurationDetails.add(btnApplyPipelineConfig,
				gridBagConstraints);
		...
		tabConfig
				.addTab(org.openide.util.NbBundle
						.getMessage(IDROPConfigurationPanel.class,
								"IDROPConfigurationPanel.pnlPipelineConfiguration.TabConstraints.tabTitle"),
						pnlPipelineConfiguration); // NOI18N
