...
public class FinderRenameIRODSDirectoryDialog extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4860632351187835494L;
	...
	public static org.slf4j.Logger log = LoggerFactory
			.getLogger(FinderRenameIRODSDirectoryDialog.class);

	/** Creates new form NewIRODSDirectoryDialog */
	public FinderRenameIRODSDirectoryDialog(final IRODSFinderDialog parent,
			final boolean modal, final String currentAbsolutePath,
			final IRODSFinderTree irodsTree, final IRODSNode currentNode) {
		super(parent, modal);
	...
	private void doRename() {
		...
		if (txtNewFolder.getText().isEmpty()) {
			...
			MessageManager.showError(this,
					"please enter a new file or collection name",
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					IRODSFinderOutlineModel irodsOutlineModel = (IRODSFinderOutlineModel) irodsTree
							.getModel();
					...
					TreePath pathForOld = FinderUtils
					...
					if (pathForOld == null) {
						...
						CollectionAndDataObjectListingEntry nodesEntry = (CollectionAndDataObjectListingEntry) oldNode
								.getUserObject();
						IRODSFile newEntryAsFile = irodsFinderDialog
								.getIdropCore()
					...
					MessageManager.showMessage(irodsFinderDialog,
							"The rename was successful",
							MessageManager.TITLE_MESSAGE);

				} catch (Exception ex) {
					Logger.getLogger(
							FinderRenameIRODSDirectoryDialog.class.getName())
