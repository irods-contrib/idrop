...
public class IRODSInfoDialog extends javax.swing.JDialog implements
						...
						public void mouseClicked(final MouseEvent evt) {
							if (evt.getClickCount() == 2) {
								...
								MetadataTableModel model = (MetadataTableModel) tableMetadata
										.getModel();
								MetaDataAndDomainData metaDataAndDomainData = model
										.getRow(row);
								AvuData avuData = new AvuData();
								String attr = metaDataAndDomainData
										.getAvuAttribute();
								avuData.setAttribute(attr);
								String value = metaDataAndDomainData
										.getAvuValue();
								avuData.setValue(value);
								String unit = metaDataAndDomainData
										.getAvuUnit();
								avuData.setUnit(unit);

								EditMetaDataDialog editMetaDataDialog = new EditMetaDataDialog(
										null, true, row,
										selectedObjectFullPath, avuData,
										isCollection(), irodsFileSystem,
										irodsAccount, model);

								editMetaDataDialog.setLocation((int) dialog
	...
	private void initPermissionInfo() {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				// javax.swing.JComboBox tableCombo = new
	...
	private void initComponents() {
		...
		pnlReplication.add(scrollReplicationResources,
		...
		btnReplicate
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/org/irods/jargon/idrop/desktop/systraygui/images/glyphicons_464_server_plus.png"))); // NOI18N
		btnReplicate.setMnemonic('p');
		btnReplicate.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.btnReplicate.text")); // NOI18N
		btnReplicate.setToolTipText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class,
				"IRODSInfoDialog.btnReplicate.toolTipText")); // NOI18N
		...
		pnlInfoCards.setPreferredSize(new java.awt.Dimension(555, 750));
		...
		tableMetadata.setModel(new javax.swing.table.DefaultTableModel(
			...
			/**
					 * 
					 */
			private static final long serialVersionUID = 8725220150473921108L;
		...
		jPanel10.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 2, 2,
				2));
		...
		btnAddMetadata.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.btnAddMetadata.text")); // NOI18N
		btnAddMetadata.setToolTipText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class,
				"IRODSInfoDialog.btnAddMetadata.toolTipText")); // NOI18N
		...
		btnDeleteMetadata.setText(org.openide.util.NbBundle
				.getMessage(IRODSInfoDialog.class,
						"IRODSInfoDialog.btnDeleteMetadata.text")); // NOI18N
		btnDeleteMetadata.setToolTipText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class,
				"IRODSInfoDialog.btnDeleteMetadata.toolTipText")); // NOI18N
		...
		btnAddSharePermissions.setToolTipText(org.openide.util.NbBundle
				.getMessage(IRODSInfoDialog.class,
						"IRODSInfoDialog.btnAddSharePermissions.toolTipText")); // NOI18N
		...
		btnDeleteSharePermissions
				.setToolTipText(org.openide.util.NbBundle
						.getMessage(IRODSInfoDialog.class,
								"IRODSInfoDialog.btnDeleteSharePermissions.toolTipText")); // NOI18N
		...
		btnRefresh.setToolTipText(org.openide.util.NbBundle
				.getMessage(IRODSInfoDialog.class,
						"IRODSInfoDialog.btnRefresh.toolTipText")); // NOI18N
		...
		btnClose.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.text")); // NOI18N
		btnClose.setToolTipText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.toolTipText")); // NOI18N
		...
		if ((JOptionPane.showConfirmDialog(this, msg1, "Delete Metadata",
			...
			try {
				...
				for (int i = numRowsSelected - 1; i >= 0; i--) {
					int selectedRow = selectedRows[i];
					if (selectedRow >= 0) {
						// PermissionsTableModel model = (PermissionsTableModel)
						// tablePermissions
						// .getModel();
						model.deleteRow(selectedRow);
