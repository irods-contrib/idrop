...
public class IRODSInfoDialog extends javax.swing.JDialog implements
	...
	private void initComponents() {
		...
		lblIcon.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.lblIcon.text")); // NOI18N
		...
		lblParentCollection.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class,
				"IRODSInfoDialog.lblParentCollection.text")); // NOI18N
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 2;
		...
		btnEdit.setText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.btnEdit.text")); // NOI18N
		btnEdit.setToolTipText(org.openide.util.NbBundle.getMessage(
				IRODSInfoDialog.class, "IRODSInfoDialog.btnEdit.toolTipText")); // NOI18N
