...
public class MetadataViewDialog extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -824163873661209387L;
	...
	public MetadataViewDialog(final iDrop idropGui,
			final IRODSAccount irodsAccount, final String absolutePath) {
		super(idropGui, true);
		this.idropGui = idropGui;
		this.irodsAccount = irodsAccount;
		irodsAbsolutePath = absolutePath;
		collection = true;
		fileName = "";
		initComponents();
		initializeMetadata();
		...
		pnlTopLayout.setHorizontalGroup(pnlTopLayout.createParallelGroup(
				...
				pnlTopLayout
						...
						.add(lblAbsolutePath,
								...
								596, Short.MAX_VALUE).addContainerGap()));
