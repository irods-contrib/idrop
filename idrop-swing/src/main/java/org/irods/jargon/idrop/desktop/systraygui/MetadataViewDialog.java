...
public class MetadataViewDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlTopLayout.setHorizontalGroup(pnlTopLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                pnlTopLayout.createSequentialGroup().addContainerGap()
        ...
        pnlTopLayout.setVerticalGroup(pnlTopLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                pnlTopLayout
                        ...
                        .add(10, 10, 10)
                        .add(lblAbsolutePath, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 33,
        ...
        tableMetadata.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null, null },
            ...
            public void run() {
                try {
                    ...
                    if (collection) {
                        ...
                        metadataTableModel = new MetadataTableModel(irodsFileService
                                .getMetadataForCollection(irodsAbsolutePath));
                    } else {
                        lblAbsolutePath.setText(irodsAbsolutePath + "/" + fileName);
                        metadataTableModel = new MetadataTableModel(irodsFileService.getMetadataForDataObject(
